...
export default function Card(props) {
    return (
        <div className="travel-card">
            <img src = {props.image} alt="mountain top" className="travel-img"/>
                <div>
                    <div className="travel-location">
                        ...
                        <p className="travel-country" >{props.country.toUpperCase()}</p>
                        <a href="index.html">View on Google Maps</a>
                    </div>
                    <h1 className="travel-title">{props.title}</h1>
                    <p className="travel-period">{props.startDate} - {props.endDate}</p>
